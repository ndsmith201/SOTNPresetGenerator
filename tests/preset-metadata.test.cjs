...
test("generated metadata uses the current name and configured author without mutating saved inputs", () => {
  ...
  assert.deepEqual(result.metadata.author, ["New author"]);
...
test("raw JSON options cannot replace the preset name or configured author", () => {
