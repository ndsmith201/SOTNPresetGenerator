...
const placementLabels: Record<WritePlacement, string> = {
  default: "Default placement", "game-init": "Game initialization", "item-init": "Item initialization", "after-relics": "After relic writes", "main-block": "Main block"
};
const starts = [
